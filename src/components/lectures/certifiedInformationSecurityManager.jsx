...
const CertifiedInformationSecurityManager = ({ profile, user }) => {
  // State
  ...
  useLayoutEffect(() => {
    ...
    firebase
      .firestore()
      .collection("Certified Information Security Manager")
...
export default CertifiedInformationSecurityManager;
